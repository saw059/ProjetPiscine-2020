        ...
        <div class="container"><a class="navbar-brand logo" href="#">EBAY ECE</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="login.php">se connecter</a></li>
                ...
                <div class="block-content">
                    <div class="product-info">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="gallery">
                                    <div class="sp-wrap"><a href="assets/img/tech/image1.jpg"><img class="img-fluid d-block mx-auto" src="assets/img/tech/image1.jpg"></a><a href="assets/img/tech/shopping.png"><img class="img-fluid d-block mx-auto" src="assets/img/tech/image1.jpg"></a><a href="assets/img/tech/image1.jpg"><img class="img-fluid d-block mx-auto" src="assets/img/tech/image1.jpg"></a></div>
                                </div><img src="assets/img/tech/shopping.png"></div>
                            <div class="col-md-6 offset-xl-0">
                                <div class="info">
                                    ...
                                    <div class="price">
                                        <h3>$20300.00</h3>
                                    </div><button class="btn btn-primary" type="button" style="margin: 10px;"><a href="#" style="color: white;">meilleur offre</a></button><button class="btn btn-primary" type="button" style="margin: 10px;"><a href="&quot;acheter.php&quot;" style="color: white;">Encherir</a></button>
                                    <button
                                        class="btn btn-primary" type="button" style="margin: 10px;"><a href="&quot;acheter.php&quot;" style="color: white;">acheter</a></button><button class="btn btn-primary" type="button" style="float: right;margin: 10px;"><i class="icon-basket"></i><a href="&quot;panier.php&quot;" style="color: white;">panier</a></button>
                                        <div
                                            class="summary"></div>
                            </div>
                        </div>
