        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>pour pouvoir encherir il faut d'abord te connecter</p>
                </div>
                <form method="post" action="testLogin2.php">
                    <div class="form-group"><label for="email">Email</label><input class="form-control item" type="email" id="email" name="email"></div>
                    <div class="form-group"><label for="password">mot de passe</label><input class="form-control" type="password" id="password" name="motDePasse"></div>
                    <div class="form-group">
                        <div class="form-check"><input class="form-check-input" type="checkbox" id="checkbox"><label class="form-check-label" for="checkbox">Remember me</label></div>
                    </div>
                    <input type="submit" value="se connecter" class="btn btn-primary" style="float: right;">
                </form>
            </div>
            <p class="nav-link">tu n'as pas de compte? clique ici&nbsp;&nbsp;<a href="registration.php">s'inscrire</a>&nbsp;</p>
        </section>
    </main>
