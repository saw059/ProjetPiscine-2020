        ...
        <section class="clean-block clean-catalog dark">
            ...
            <div class="container">
                <div class="block-heading">
                    ...
                    <h2 class="text-info">Espace ADMIN</h2>
                            ...
                            <div class="d-none d-md-block">
                                <div class="filters">
                                    <div class="filter-item">
                                        <h3>PRODUIT:</h3>
                                        <button
                                        class="btn btn-primary" type="button" style="margin: 10px;"><a href="ajouter_annonce3.php" style="color: white;">ajouter</a></button>
                                    </div>
                                ...
                                <?php
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            ...
                                            <a href="delete.php?id= <?php echo $donnees['ID'] ?>"><button class="btn btn-primary" type="button" style="margin: 10px;">supprimer</button></a>
                            ...
                            <div class="d-none d-md-block">
                                <div class="filters">
                                    <div class="filter-item">
                                        <h3>Utiliateurs:</h3>
                                        <button
                                        class="btn btn-primary" type="button" style="margin: 10px;"><a href="registration2.php" style="color: white;">ajouter</a></button>
                                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="products">
                                <div class="row no-gutters">
                                    ...
                                    $reponse = $bdd->query('SELECT * FROM utilisateurs where type="acheteur"OR type="vendeur"');
                                    // On affiche chaque entrée une à une
                                    while ($donnees = $reponse->fetch())
                                    {
                                    ?> 
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            ...
                                            <a href="deleteU.php?id= <?php echo $donnees['ID'] ?>"><button class="btn btn-primary" type="button" style="margin: 10px;">supprimer</button></a>
