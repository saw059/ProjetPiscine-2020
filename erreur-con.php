        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">OUPS!</h2><img src="assets/img/erreur.gif" style="opacity: 0.4;">
                    <p>Vous n'etes pas inscrit ,vous devez d'abord vous inscrire en cliquant en bas</p>
                </div>
                <a href="registration.php"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></a>
            </div>
        </section>
    </main>
