        ...
        <section class="clean-block clean-catalog dark">
                ...
                <div class="container-fluid"><a class="navbar-brand" href="compte.php"><i class="icon-user"></i>votre compte</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-3"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <a role="presentation" class="dropdown-item" href="achat.php">Tout voir</a>
                            </div>
                            </li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#"></a></li>
            ...
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>Tous les produits diponibles</p>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="col-md-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            <a href="assets/img/tech/shopping.png"><img class="img-fluid d-block mx-auto" src="assets/img/tech/shopping.png"></a>
                                            <div class="product-name">
                                                <a href="piece-en-or.php">piece en or</a>
                                            </div>
                                            ...
                                            <button class="btn btn-primary" type="button" style="margin: 10px;"><a href="#" style="color: white;">offre</a></button>
                                    <a href="encherir.php"><button  class="btn btn-primary" type="button" style="margin: 10px;"style="color: white;">Encherir</button></a>
                                    
                                    <button
                                        class="btn btn-primary" type="button" style="margin: 10px;"><a href="acheter.php" style="color: white;">acheter</a></button>
                                        <button class="btn btn-primary" type="button" style="float: right;margin: 10px;"><i class="icon-basket"></i>
                                            <a href="panier.php" style="color: white;">Add</a></button>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            <a href="assets/img/tech/stylo.jpg"><img class="img-fluid d-block mx-auto" src="assets/img/tech/stylo.jpg"></a>
                                            <div class="product-name"><a href="#">Pelikan - Stylo à plume</a></div>
                                            <div class="about">
                                                <div class="rating"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star-half-empty.svg"><img src="assets/img/star-empty.svg"></div>
                                                <div class="price">
                                                    <h3>1800$</h3>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            <div class="image"><a href="#"></a></div>
                                            <div class="product-name"><a href="#">p</a></div>
                                            <div class="about">
                                                <div class="rating"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star-half-empty.svg"><img src="assets/img/star-empty.svg"></div>
                                                <div class="price">
                                                    <h3>$100</h3>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="clean-product-item">
                                            <div class="image"><a href="#"></a><a href="#"></a></div>
                                            <div class="product-name"><a href="#">Lorem ipsum dolor sit amet</a></div>
                                            <div class="about">
                                                <div class="rating"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star-half-empty.svg"><img src="assets/img/star-empty.svg"></div>
                                                <div class="price">
